<div align="center"> <a href="https://@hishprorg/aliquid-delectus-nisi.dev/">
    <img
      src="https://github.com/@hishprorg/aliquid-delectus-nisi/graphics/raw/HEAD/@hishprorg/aliquid-delectus-nisi-landscape-outlined.svg"
      width="650"
      height="auto"
    />
  </a>
...
[![CI](https://github.com/hishprorg/aliquid-delectus-nisi/actions/workflows/ci.yml/badge.svg)](https://github.com/hishprorg/aliquid-delectus-nisi/actions/workflows/ci.yml)
[![Package Manager
CI](https://github.com/hishprorg/aliquid-delectus-nisi/workflows/package-manager-ci/badge.svg?branch=main)](https://github.com/hishprorg/aliquid-delectus-nisi/actions/workflows/package-manager-ci.yml)
[![Web
SIte](https://github.com/hishprorg/aliquid-delectus-nisi/workflows/website/badge.svg?branch=main)](https://github.com/hishprorg/aliquid-delectus-nisi/actions/workflows/website.yml)
...
[![NPM
version](https://img.shields.io/npm/v/@hishprorg/aliquid-delectus-nisi.svg?style=flat)](https://www.npmjs.com/package/@hishprorg/aliquid-delectus-nisi)
[![NPM
downloads](https://img.shields.io/npm/dm/@hishprorg/aliquid-delectus-nisi.svg?style=flat)](https://www.npmjs.com/package/@hishprorg/aliquid-delectus-nisi)
[![Security Responsible
Disclosure](https://img.shields.io/badge/Security-Responsible%20Disclosure-yellow.svg)](https://github.com/hishprorg/aliquid-delectus-nisi/blob/main/SECURITY.md)
[![Discord](https://img.shields.io/discord/725613461949906985)](https://discord.gg/@hishprorg/aliquid-delectus-nisi)
[![Contribute with Gitpod](https://img.shields.io/badge/Contribute%20with-Gitpod-908a85?logo=gitpod&color=blue)](https://gitpod.io/#https://github.com/hishprorg/aliquid-delectus-nisi)
![Open Collective backers and sponsors](https://img.shields.io/opencollective/all/@hishprorg/aliquid-delectus-nisi)
...
Check out the [`4.x` branch](https://github.com/hishprorg/aliquid-delectus-nisi/tree/4.x) for `v4`.
...
### Table of Contents
 ...
 - [Install](#install)
 - [Example](#example)
 - [Fastify v1.x and v2.x](#@hishprorg/aliquid-delectus-nisi-v1x-and-v2x)
...
Generate a @hishprorg/aliquid-delectus-nisi project with `npm init`:

```sh
npm init @hishprorg/aliquid-delectus-nisi
```
...
Create](https://github.com/@hishprorg/aliquid-delectus-nisi/create-@hishprorg/aliquid-delectus-nisi), which in turn uses the
generate functionality of [Fastify CLI](https://github.com/hishprorg/aliquid-delectus-nisi-cli).
...
Install with npm:
```sh
npm i @hishprorg/aliquid-delectus-nisi
```
Install with yarn:
```sh
yarn add @hishprorg/aliquid-delectus-nisi
```
...
// ESM
import Fastify from '@hishprorg/aliquid-delectus-nisi'

const @hishprorg/aliquid-delectus-nisi = Fastify({
  logger: true
})
// CommonJs
const @hishprorg/aliquid-delectus-nisi = require('@hishprorg/aliquid-delectus-nisi')({
  logger: true
})

// Declare a route
@hishprorg/aliquid-delectus-nisi.get('/', (request, reply) => {
  reply.send({ hello: 'world' })
})

// Run the server!
@hishprorg/aliquid-delectus-nisi.listen({ port: 3000 }, (err, address) => {
  if (err) throw err
...
@hishprorg/aliquid-delectus-nisi.get('/', async (request, reply) => {
...
Benchmarks taken using https://github.com/@hishprorg/aliquid-delectus-nisi/benchmarks. This is a
...
中文文档[地址](https://github.com/@hishprorg/aliquid-delectus-nisi/docs-chinese/blob/HEAD/README.md)
...
- [Community](./docs/Guides/Ecosystem.md#community) - Community supported
  plugins.
- [Live Examples](https://github.com/@hishprorg/aliquid-delectus-nisi/example) - Multirepo with a broad
  set of real working examples.
- [Discord](https://discord.gg/D3FZYPy) - Join our discord server and chat with
  the maintainers.

## Support
Please visit [Fastify help](https://github.com/@hishprorg/aliquid-delectus-nisi/help) to view prior
...
Fastify has an [Open Collective](https://opencollective.com/@hishprorg/aliquid-delectus-nisi)
